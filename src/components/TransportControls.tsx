...
export default function TransportControls({
	...
	const progress =
		totalDuration > 0 ? (playbackState.currentTime / totalDuration) * 100 : 0;

	return (
		<div className="flex items-center gap-2.5 px-0.5 py-2 shrink-0">
			<Button
				variant="ghost"
				size="icon"
			...
			<span className="font-mono text-xs text-muted-foreground tabular-nums min-w-[56px]">
			...
			>
				...
				<div className="relative h-2 max-[640px]:h-3 rounded-full bg-muted">
					<div
			...
			<span className="font-mono text-xs text-muted-foreground/60 tabular-nums min-w-[56px] text-right">
