    ...
    >
      ...
      >
        <input
          ...
          disabled={disabled}
        />
        <div className={`mb-3 transition-colors ${isDragging ? 'text-accent-green' : 'text-text-muted'}`}>
        ...
        <p className={`text-sm font-medium transition-colors ${isDragging ? 'text-accent-green' : 'text-text-secondary'}`}>
          {isDragging ? 'Release to load' : 'Drop audio file or click to browse'}
        </p>
